        ...
        <div className="min-h-screen bg-gray-50 text-black">
            ...
            <section className="w-full bg-linear-to-b from-white to-gray-50 py-16 px-6 md:px-12 flex flex-col md:flex-row items-center gap-10 md:gap-16 overflow-hidden">
                ...
                <div className="md:w-1/2 relative w-full h-72 md:h-96 rounded-2xl overflow-hidden shadow-md">
                    <div className="absolute inset-0 animate-fadeShow">
                        <img
                    ...
                    <div className="absolute inset-0 animate-fadeShow delay-[5s]">
                        <img
                            src="https://images.unsplash.com/photo-1600508774630-3d27b95b3a5b?auto=format&fit=crop&w=800&q=80"
                            alt="Spa"
                            className="w-full h-full object-cover rounded-2xl"
                        />
                    </div>
                    <div className="absolute inset-0 animate-fadeShow delay-[10s]">
                        <img
                    ...
                    <div className="absolute inset-0 animate-fadeShow delay-[15s]">
                        <img
                            src="https://images.unsplash.com/photo-1606813902917-8c3b66e44382?auto=format&fit=crop&w=800&q=80"
                            alt="Dentist"
                            className="w-full h-full object-cover rounded-2xl"
                        />
                    </div>
