...
export default function HomePage() {
  ...
  const [homeType, setHomeType] = useState<"public" | "user" | "partner" | "admin">("public");
  ...
  useEffect(() => {
    ...
    if (user.role === "user") setHomeType("user");
    else if (user.role === "partner") setHomeType("partner");
    else if (user.role === "admin") setHomeType("admin");
    else setHomeType("public");
  }, [user, loading]);
  ...
  switch (homeType) {
    ...
    case "admin":
      return (
        <div className="p-4">
          <h1 className="text-2xl font-semibold">Khu vực Admin</h1>
