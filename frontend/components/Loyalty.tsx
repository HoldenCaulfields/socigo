        ...
        <section id="tich-diem" className="py-20 bg-linear-to-b from-gray-50 to-white relative overflow-hidden font-sans">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="overflow-x-auto lg:overflow-visible">
                    <div className="grid grid-cols-4 gap-6 min-w-[800px] lg:min-w-full">
                        {rewards.map((reward, idx) => (
                            ...
                            >
                                ...
                                <h3 className="text-xl font-bold mb-1 text-gray-800 group-hover:translate-x-1 transition-transform duration-300 font-sans">
                                    {reward.service}
                                </h3>
