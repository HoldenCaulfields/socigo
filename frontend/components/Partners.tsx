import { Coffee, Heart, Home, Car, Dumbbell, Smile } from 'lucide-react';

export default function Partners() {
    const partners = [
        { name: 'Nha Khoa Diamond', category: 'Nha khoa', discount: '30%', icon: Heart },
        { name: 'Spa Luxury Beauty', category: 'Spa & Thẩm mỹ', discount: '25%', icon: Smile },
        { name: 'Hotel Paradise', category: 'Khách sạn', discount: '40%', icon: Home },
        { name: 'Premium Car Rental', category: 'Thuê xe', discount: '20%', icon: Car },
        { name: 'Fitness Center Pro', category: 'Gym & Fitness', discount: '35%', icon: Dumbbell },
        { name: 'Restaurant Gourmet', category: 'Nhà hàng', discount: '15%', icon: Coffee },
    ];
                ...
                <div className="flex space-x-8 animate-scroll">
                    {[...partners, ...partners, ...partners].map((partner, idx) => {
                        ...
                        return (
                            <div
                                key={idx}
                                className="shrink-0 bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-110 w-80 border-2 border-transparent hover:border-gray-900 group cursor-pointer"
                            >
                                <div className="flex items-center justify-between mb-4">
                                    <div className="w-12 h-12 flex items-center justify-center bg-linear-to-br from-gray-900 to-gray-700 rounded-xl shadow-md group-hover:rotate-12 transition-transform duration-300">
