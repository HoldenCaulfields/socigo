        ...
        <section id="tinh-nang" className="py-20 bg-linear-to-b from-white to-gray-50 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="overflow-x-auto lg:overflow-visible">
                    <div className="grid grid-cols-4 gap-6 min-w-[800px] lg:min-w-full cursor-pointer px-2">
                        {features.map((feature, idx) => (
                            ...
                            >
                                <div
                                    className={`w-14 h-14 sm:w-16 sm:h-16 bg-linear-to-br ${feature.iconColor} rounded-xl sm:rounded-2xl flex items-center justify-center mb-5 sm:mb-6 transform group-hover:rotate-6 group-hover:scale-105 transition-all duration-300 shadow-lg group-hover:shadow-xl relative z-10`}
                                >
                                    <feature.icon className="w-7 h-7 sm:w-8 sm:h-8 text-white" />
                                </div>
                                <h3
                                    className={`text-lg sm:text-xl font-bold mb-2 text-gray-900 ${feature.hoverText} transition-colors duration-300 relative z-10`}
                                >
                                    {feature.title}
                                </h3>
